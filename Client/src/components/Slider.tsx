...
export default function Slider() {
  ...
  return (
    <Container>
      <div className="w-full bg-[#B2CCFF82] mx-auto p-4">
        <div className="relative w-full rounded-2xl overflow-hidden shadow-xl bg-gradient-to-bl from-blue-200/40 via-white/60 to-teal-100/40">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#050915d0] via-[#121a31b8] to-[#fff0]" />
            <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-white/50 via-white/20 to-transparent backdrop-blur-[8px]" />
          </div>
          ...
          <div className="relative z-10 flex flex-col h-auto md:h-[340px] p-4 sm:p-6">
            ...
            <div className="mt-12 flex gap-2 flex-wrap xl:flex-nowrap items-end" style={{ marginTop: '50px' }}>
              {/* Stats Cards Container */}
              <div className="flex gap-2 flex-wrap md:flex-nowrap w-full xl:w-auto">
                {/* Total Athletes */}
                ...
                {/* Consistency Score */}
                <div className="bg-white/95 backdrop-blur-[3px] rounded-2xl shadow-md flex-shrink-0 w-full sm:w-[calc(50%-0.25rem)] md:w-[263px] h-[78px] flex items-center px-4 gap-3">
                  <div className="flex-1 min-w-0">
              ...
              {/* Weekly Streak Card */}
              <div className="w-full xl:w-[300px] flex flex-col justify-between rounded-2xl bg-white/95 backdrop-blur-[2.5px] shadow-lg p-5 mt-2 xl:mt-0 min-h-[200px]">
                {/* Streak + Labels Row */}
